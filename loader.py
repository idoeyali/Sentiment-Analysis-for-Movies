...
my_test_texts.append("I really liked the start, the rest of the movie was not so good")
my_test_texts.append("I thought that I am going to watch the worst movie, but I got totally wrong")
my_test_texts.append("If at the beginning I was thinking that the movie do not worth watching it, "
                     "now i think that everyone should watch it")
my_test_labels = ["negative", "positive", "negative", "positive", "positive"]
